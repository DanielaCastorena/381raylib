...
// #if AS9_VERSION < AS9_VERSION_CHECK(2, 1, 0)
//     // do stuff
// #endif
//
// Returns an integer which may be used in comparisons
#define AS9_VERSION_CHECK( major, minor, patch ) ( ((major)<<16) | ((minor)<<8) | (patch) )

#define AS9_VERSION_MAJOR  0
#define AS9_VERSION_MINOR  1
#define AS9_VERSION_PATCH  0
...
#define AS9_VERSION  AS9_VERSION_CHECK( 0, 1, 0 )
...
namespace VersionInfo {
    ...
    constexpr std::string_view VERSION_STR = "AS9 HEAD-HASH-NOTFOUND";
